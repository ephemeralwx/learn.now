      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => ResultWidget(
            functionName: params.getParam('functionName', ParamType.String),
            questionPrompt: params.getParam('questionPrompt', ParamType.String),
            apiResult: params.getParam('apiResult', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'TopThreeVideosDisplayResults',
          path: '/topThreeVideosDisplayResults',
          builder: (context, params) => TopThreeVideosDisplayResultsWidget(
            prompt: params.getParam('prompt', ParamType.String),
            apiResult: params.getParam('apiResult', ParamType.JSON),
            recency: params.getParam('recency', ParamType.int),
          ),
        )
