...
class _YTTopThreeYTVidsWidgetState extends State<YTTopThreeYTVidsWidget> {
  late YTTopThreeYTVidsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => YTTopThreeYTVidsModel());
            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  obscureText: false,
                  decoration: InputDecoration(
                    labelText: 'Recency (years) (Optional // Default =3)',
                    labelStyle: FlutterFlowTheme.of(context).labelMedium,
                    hintStyle: FlutterFlowTheme.of(context).labelMedium,
                    enabledBorder: UnderlineInputBorder(
                      borderSide: BorderSide(
                  ...
                  validator:
                      _model.recencyControllerValidator.asValidator(context),
                  inputFormatters: [
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    _model.youtubeTopThreeVideosAPIResult =
                        await YoutubeGetTopThreeVideosCall.call(
                      prompt: _model.promptController.text,
                      recency: valueOrDefault<int>(
                        int.tryParse(_model.recencyController.text),
                        3,
                      ),
                    );
                    if ((_model.youtubeTopThreeVideosAPIResult?.succeeded ??
                        true)) {
                      context.pushNamed(
                        'TopThreeVideosDisplayResults',
                        queryParameters: {
                          ...
                          'apiResult': serializeParam(
                            (_model.youtubeTopThreeVideosAPIResult?.jsonBody ??
                                ''),
                            ParamType.JSON,
                          ),
                          'recency': serializeParam(
                            int.tryParse(_model.recencyController.text),
                            ParamType.int,
                          ),
                        }.withoutNulls,
