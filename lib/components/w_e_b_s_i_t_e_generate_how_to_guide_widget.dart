...
class WEBSITEGenerateHowToGuideWidget extends StatefulWidget {
  ...
  _WEBSITEGenerateHowToGuideWidgetState createState() =>
      _WEBSITEGenerateHowToGuideWidgetState();
}

class _WEBSITEGenerateHowToGuideWidgetState
    extends State<WEBSITEGenerateHowToGuideWidget> {
  late WEBSITEGenerateHowToGuideModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WEBSITEGenerateHowToGuideModel());
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    _model.websiteGenHowToGuideAPIResult =
                        await WebsiteGenHowToGuideCall.call(
                      url: _model.websiteURLController.text,
                    );
                    if ((_model.websiteGenHowToGuideAPIResult?.succeeded ??
                        true)) {
                      context.pushNamed(
                        'result',
                        queryParameters: {
                          ...
                          'apiResult': serializeParam(
                            getJsonField(
                              (_model.websiteGenHowToGuideAPIResult?.jsonBody ??
                                  ''),
                              r'''$.guide''',
                            ).toString(),
                            ParamType.String,
