...
class YTExtractHowToGuideWidget extends StatefulWidget {
  ...
  _YTExtractHowToGuideWidgetState createState() =>
      _YTExtractHowToGuideWidgetState();
}

class _YTExtractHowToGuideWidgetState extends State<YTExtractHowToGuideWidget> {
  late YTExtractHowToGuideModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => YTExtractHowToGuideModel());
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    _model.youtubeHowToGuideAPIResult =
                        await YoutubeGetHowToGuideCall.call(
                      youtubeUrl: _model.youtubeVidURLController.text,
                    );
                    if ((_model.youtubeHowToGuideAPIResult?.succeeded ??
                        true)) {
                      context.pushNamed(
                        'result',
                        queryParameters: {
                          'functionName': serializeParam(
                            'Extract How-To Guide',
                            ParamType.String,
                          ),
                          'apiResult': serializeParam(
                            getJsonField(
                              (_model.youtubeHowToGuideAPIResult?.jsonBody ??
                                  ''),
                              r'''$.howto_guide''',
                            ).toString(),
                            ParamType.String,
