...
class WEBSITEAskQuestionToWebsiteWidget extends StatefulWidget {
  ...
  _WEBSITEAskQuestionToWebsiteWidgetState createState() =>
      _WEBSITEAskQuestionToWebsiteWidgetState();
}

class _WEBSITEAskQuestionToWebsiteWidgetState
    extends State<WEBSITEAskQuestionToWebsiteWidget> {
  late WEBSITEAskQuestionToWebsiteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WEBSITEAskQuestionToWebsiteModel());
            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  style: FlutterFlowTheme.of(context).bodyMedium,
                  validator: _model.questionpromptControllerValidator
                      .asValidator(context),
                ),
              ),
              Align(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    _model.websiteAskQuestionAPIResult =
                        await WebsiteAskQuestionCall.call(
                      url: _model.websiteURLController.text,
                      question: _model.questionpromptController.text,
                    );
                    if ((_model.websiteAskQuestionAPIResult?.succeeded ??
                        true)) {
                      context.pushNamed(
                        'result',
                        queryParameters: {
                          'functionName': serializeParam(
                            'Ask Question To A Website',
                            ParamType.String,
                          ),
                          'apiResult': serializeParam(
                            getJsonField(
                              (_model.websiteAskQuestionAPIResult?.jsonBody ??
                                  ''),
                              r'''$.answer''',
                            ).toString(),
                            ParamType.String,
